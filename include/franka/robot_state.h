...
struct RobotState {
   ...
   * Filtered torques on joints generated by external forces (does not include configured
   * end-effector and load). Unit: \f$[Nm]\f$.
   */
   ...
   * relative to the base frame. Becomes \f$[0,0,0,0,0,0]\f$
   * when near a singularity. See also @ref k-frame "K frame".
   ...
   * expressed relative to the stiffness frame. Becomes \f$[0,0,0,0,0,0]\f$
   * when near a singularity. See also @ref k-frame "K frame".
   * Unit: \f$[N,N,N,Nm,Nm,Nm]\f$.
   */
