...
int main(int argc, char** argv) {
  ...
  try {
    ...
    std::array<double, 7> upper_torque_thresholds_acceleration{
        35.0, 35.0, 32.0, 30.0, 29.0, 27.0, 24.0};
    std::array<double, 6> lower_force_thresholds_nominal{30.0, 30.0, 30.0,
                                                         25.0, 25.0, 25.0};
    std::array<double, 6> upper_force_thresholds_nominal{40.0, 40.0, 40.0,
                                                         35.0, 35.0, 35.0};
    std::array<double, 6> lower_force_thresholds_acceleration{30.0, 30.0, 30.0,
                                                              25.0, 25.0, 25.0};
    std::array<double, 6> upper_force_thresholds_acceleration{40.0, 40.0, 40.0,
                                                              35.0, 35.0, 35.0};
