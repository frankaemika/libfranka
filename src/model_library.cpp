...
ModelLibrary::ModelLibrary()
    : loader_("libfcimodels"),
      ...
      joint0{reinterpret_cast<decltype(&O_T_J1_file)>(
          loader_.getSymbol("O_T_J1_file"))},
      joint1{reinterpret_cast<decltype(&O_T_J2_file)>(
          loader_.getSymbol("O_T_J2_file"))},
      joint2{reinterpret_cast<decltype(&O_T_J3_file)>(
          loader_.getSymbol("O_T_J3_file"))},
      joint3{reinterpret_cast<decltype(&O_T_J4_file)>(
          loader_.getSymbol("O_T_J4_file"))},
      joint4{reinterpret_cast<decltype(&O_T_J5_file)>(
          loader_.getSymbol("O_T_J5_file"))},
      joint5{reinterpret_cast<decltype(&O_T_J6_file)>(
          loader_.getSymbol("O_T_J6_file"))},
      joint6{reinterpret_cast<decltype(&O_T_J7_file)>(
