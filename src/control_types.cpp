...
Torques::Torques(const std::array<double, 7>& torques) noexcept  // NOLINT (modernize-pass-by-value)
  : tau_J(torques) {
}
...
JointValues::JointValues(const std::array<double, 7>& joint_values) noexcept  // NOLINT (modernize-pass-by-value)
  : q(joint_values) {
}
...
JointVelocities::JointVelocities(const std::array<double, 7>& joint_velocities) noexcept  // NOLINT (modernize-pass-by-value)
  : dq(joint_velocities) {
}
...
CartesianPose::CartesianPose(const std::array<double, 16>& cartesian_pose) noexcept  // NOLINT (modernize-pass-by-value)
...
CartesianVelocities::CartesianVelocities(const std::array<double, 6>& cartesian_velocities)  // NOLINT (modernize-pass-by-value)
