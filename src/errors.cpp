...
std::string activeErrorsString(Errors& errors) {
  ...
  names += errors.cartesian_position_limits_violation ? "cartesian_position_limits_violation, " : "";
  ...
  names += errors.cartesian_velocity_profile_safety_violation ? "cartesian_velocity_profile_safety_violation, " : "";
  names += errors.joint_position_motion_generator_start_pose_invalid ? "joint_position_motion_generator_start_pose_invalid, " : "";
  names += errors.joint_motion_generator_position_limits_violation ? "joint_motion_generator_position_limits_violation, " : "";
  names += errors.joint_motion_generator_velocity_limits_violation ? "joint_motion_generator_velocity_limits_violation, " : "";
  names += errors.joint_motion_generator_velocity_discontinuity ? "joint_motion_generator_velocity_discontinuity, " : "";
  names += errors.joint_motion_generator_acceleration_discontinuity ? "joint_motion_generator_acceleration_discontinuity, " : "";
  names += errors.cartesian_position_motion_generator_start_pose_invalid ? "cartesian_position_motion_generator_start_pose_invalid, " : "";
  names += errors.cartesian_motion_generator_elbow_limit_violation ? "cartesian_motion_generator_elbow_limit_violation, " : "";
  names += errors.cartesian_motion_generator_velocity_limits_violation ? "cartesian_motion_generator_velocity_limits_violation, " : "";
  names += errors.cartesian_motion_generator_velocity_discontinuity ? "cartesian_motion_generator_velocity_discontinuity, " : "";
  names += errors.cartesian_motion_generator_acceleration_discontinuity ? "cartesian_motion_generator_acceleration_discontinuity, " : "";
  names += errors.cartesian_motion_generator_elbow_sign_inconsistent ? "cartesian_motion_generator_elbow_sign_inconsistent, " : "";
  names += errors.cartesian_motion_generator_start_elbow_invalid ? "cartesian_motion_generator_start_elbow_invalid, " : "";
  names += errors.force_controller_desired_force_tolerance_violation ? "force_controller_desired_force_tolerance_violation, " : "";
